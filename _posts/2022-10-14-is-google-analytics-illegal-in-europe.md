...
-   Several European Data Protection Authorities (DPAs) have "banned" GA from the respective countries.

1.  What did the authorities actually say?
    --------------------------------------
...
1.  Where is Google Analytics illegal?
    ----------------------------------
...
1.  Where else will it be illegal?
    ------------------------------
...
1.  What about the new data transfer framework?
    -------------------------------------------
