...
{% include gif.html slug="think-about-it" alt="Think smart..." %}
...
|                                                                | GA    | SA    |
| -------------------------------------------------------------- | ----- | ----- |
| Do you want to avoid a cookie banner?                          | x     | check |
| Do you want be GDPR compliant out of the box?                  | x     | check |
| Do you want to own your data yourself?                         | x     | check |
| Are you okay to miss ~27% of your visitors due to ad-blockers? | x     | check |
| Are you okay if your analytics are shared with other products? | x     | check |
| Do you want to have your data within in the EU?                | x     | check |
| Do you want analytics to be free?                              | check | x     |
