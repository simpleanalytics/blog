...
![utm-referrals](https://assets.simpleanalytics.com/blog/For%20marketers/utm-referrals.png)

## Add events to measure conversions
...
![events dashboard](https://assets.simpleanalytics.com/blog/For%20marketers/events-dashboard.png)
...
[Google Analytics is shutting down](/blog/google-to-sunset-universal-analytics-in-2023) its Universal Analytics properties in 2023. To keep this data, you can choose to import it into Simple Analytics. We built an import tool where you can import your data in just a few clicks.
...
![email reports](https://assets.simpleanalytics.com/blog/For%20marketers/email-reports.png)
...
We ran a [performance test](/blog/google-penalizes-you-for-using-google-analytics) using Google Lighthouse to show the actual impact. There is a difference of 10 basis points in website performance between Simple Analytics and Google Analytics.

![lighthouse analytics comparison](https://assets.simpleanalytics.com/blog/For%20marketers/core-web-vitals.png)
